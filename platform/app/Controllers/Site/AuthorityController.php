        ...
        return [
            'hr' => [
                ...
                'editorial' => [
                    ...
                    'title' => 'Kako pišemo sadržaj kojem korisnik može vjerovati',
                    ...
                    'intro' => 'Svaki tekst na AVC-u treba pomoći stvarnoj osobi: da razumije temu, prepozna opcije i napravi sljedeći korak bez osjećaja da joj netko nešto forsira.',
                    'note_label' => 'Urednički cilj',
                    'note_title' => 'Jasno, korisno i odgovorno',
                    'note_text' => 'Sadržaj treba biti dovoljno jednostavan za brzo čitanje, ali dovoljno konkretan da pomogne u odluci.',
                    'actions' => [
                        ['label' => 'Čitaj korisne članke', 'href' => '/clanci/'],
                        ['label' => 'Pitaj za preporuku', 'href' => '/#ai-advisor'],
                    ],
                    'cards' => [
                        ['label' => 'Ljudski ton', 'title' => 'Pišemo kao savjetnik, ne kao katalog', 'text' => 'Izbjegavamo prazne fraze i objašnjavamo što korisnik stvarno treba znati prije odluke.'],
                        ['label' => 'Jasna struktura', 'title' => 'Naslovi, sažeci, FAQ i povezani proizvodi', 'text' => 'Članak mora biti lak za skeniranje, posebno kada korisnik uspoređuje više opcija.'],
                        ['label' => 'Mjerljivost', 'title' => 'Gledamo što korisnicima stvarno pomaže', 'text' => 'Pratimo koje stranice vode prema preporuci, kontaktu ili službenom Forever shopu.'],
                    ],
                    'sections' => [
                        [
                            'title' => 'Načela koja koristimo kod pisanja',
                            'items' => [
                                'prvo objašnjavamo situaciju korisnika, zatim proizvode',
                                'ne koristimo dramatična obećanja ni medicinske tvrdnje koje ne pripadaju takvom sadržaju',
                                'povezujemo članak s korisnim proizvodima, ali ne prekidamo čitanje agresivnom prodajom',
                                'redovito popravljamo tekstove koji zvuče generički ili ne vode korisnika prema jasnijoj odluci',
                            ],
                        ],
                        [
                            'title' => 'Ažuriranja, linkovi i odgovornost',
                            'paragraphs' => [
                                'Kada se promijene proizvodi, cijene, dostupnost ili službeni shop linkovi, AVC nastoji ažurirati sadržaj i routing kako bi korisnik završio na ispravnom mjestu.',
                                'Ako tekst ne daje dovoljno jasnu vrijednost posjetitelju, tretiramo ga kao tekst koji treba doraditi, bez obzira na to je li tehnički SEO ispravan.',
                            ],
                        ],
                    ],
                    'cta' => [
                        'label' => 'Za posjetitelje',
                        'title' => 'Sadržaj treba olakšati odluku, ne samo privući klik',
                        'text' => 'Zato stalno spajamo članke, proizvode, preporuke i analitiku da vidimo što ljudima stvarno pomaže.',
                        'actions' => [
                            ['label' => 'Otvori članke', 'href' => '/clanci/'],
                            ['label' => 'Otvori proizvode', 'href' => '/forever-proizvodi/'],
                        ],
                    ],
                ],
