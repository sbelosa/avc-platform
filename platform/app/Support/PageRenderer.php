...
final class PageRenderer
{
    ...
    private static function analyticsBodyScript(array $options): string
    {
        ...
        return '<script>'
            ...
            . '}else{finish();}'
            . '};'
            . 'var markOutboundIntent=function(){'
            . 'document.cookie="avc_outbound_intent="+Math.floor(Date.now()/1000)+"; Max-Age=120; Path=/; SameSite=Lax";'
            . '};'
            ...
            . 'if(url.pathname==="/go/product"||url.pathname==="/go/discount"){markOutboundIntent();}'
